...
function cantarTruco()  
    ...
    function RtaIATruco()
    {
               ...
               {
                    //VERSION 2.0 RESPONDER A RETRUCO Y VALE 4
                    //Si el analisis da menos de 10 puntos, entonces responde quiero con un margen de 66%
   
                        /*    if((evaluacion<21)&&(puntos[4]==false))  //Si le cantan truco con esas cartas ACEPTA
                            {
                            ...
                            if((evaluacion<20)&&(puntos[4]==true))  //Si le cantan retruco o vale 4 con esas 3 cartas NO QUIERE
                            {
                                alert("LAZARILLO RESPONDE: NO Quiero");
                                
                                puntosdeljuego[1]+=2    //el usuario gana 2 puntos (RETRUCO NO QUERIDO)
                                return 0
                            ...
                            if((evaluacion>=21)&&(puntos[4]==false))  //Si le cantan truco con esas cartas ACEPTA
                            {
                                alert("LAZARILLO RESPONDE: Quiero retruco");
                                puntos[4]==true;
                                return 2;
