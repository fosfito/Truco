...
function truco()
    {
        ...
        {
            let val=true;
            let totalmano = 0    //si el usuario gana -1, si la pc gana +1
                  ...
                  if(mano==1)
                    {
                        ...
                        { 
                                ...
                                totalmano-=1      //gano el usuario resto 1
                        ...
                        if(mano==2)
                        {
                            ...
                            { 
                                    ...
                                    if (totalcartas==555)   //verifico si vengo de parda desde la primer mano
                                    {
                                        if(puntos[4]==true)
                                        {
